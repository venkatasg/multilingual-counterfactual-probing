...
FN = "all_results_4_8_all_alphas.csv"
#FN = "all_results_thirdparty.csv"
ALPHA_TO_USE = 3
NUM_CLASSIFIERS = 0

d = read_csv(FN) %>%
  filter(num_classifiers == 8 & !grepl("xlm", model)  |
         num_classifiers == 4 & grepl("xlm", model)) %>%
...
makeplot(filter(d.sum, opposite.push =="push away from template dir.",
              ...
              !grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "mbert_alpha3_pushaway.png"))
...
makeplot(filter(d.sum, opposite.push =="push away from template dir.",
              ...
              !grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "mbert_alpha1_pushaway.png"))
...
makeplot(filter(d.sum, opposite.push !="push away from template dir.",
              ...
              !grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "mbert_alpha3_pushto.png"))
...
makeplot(filter(d.sum, opposite.push !="push away from template dir.",
              ...
              !grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "mbert_alpha1_pushto.png"))
...
makeplot(filter(d.sum, opposite.push =="push away from template dir.",
              ...
              grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "xlm_alpha3_pushaway.png"))
...
makeplot(filter(d.sum, opposite.push !="push away from template dir.",
              ...
              grepl("xlm", model)) %>%
  mutate(word_matches_push = ifelse(`Is Random` == "control", "other", word_matches_push)),
  paste0(NUM_CLASSIFIERS, "xlm_alpha3_pushto.png"))
